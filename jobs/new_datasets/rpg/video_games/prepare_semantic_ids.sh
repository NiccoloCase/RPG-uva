...
#SBATCH --job-name=rpg_video_games_prep
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "rpg_video_games_prep"
...
runtime_stats_run "${ENV_PREFIX}/bin/python" scripts/rpg_prepare_semantic_ids.py --preset video_games
