...
#SBATCH --job-name=sasrec_video_games_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_video_games_train"
...
runtime_stats_run python3 scripts/sasrec.py --preset video_games --dataset Video_Games
