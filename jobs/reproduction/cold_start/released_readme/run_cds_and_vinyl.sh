...
#SBATCH --job-name=rpg_cold_cds_rel
...
export COLD_START_CONFIG="${COLD_START_CONFIG:-${REPO_ROOT}/configs/rpg/repro/cds_and_vinyl.yaml}"
export COLD_START_OUTPUT_DIR="${COLD_START_OUTPUT_DIR:-${REPO_ROOT}/artifacts/rpg/cold_start/released_readme/cds_and_vinyl}"
