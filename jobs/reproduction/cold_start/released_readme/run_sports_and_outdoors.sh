...
#SBATCH --job-name=rpg_cold_sports_rel
...
export COLD_START_CONFIG="${COLD_START_CONFIG:-${REPO_ROOT}/configs/rpg/repro/sports_and_outdoors.yaml}"
export COLD_START_OUTPUT_DIR="${COLD_START_OUTPUT_DIR:-${REPO_ROOT}/artifacts/rpg/cold_start/released_readme/sports_and_outdoors}"
