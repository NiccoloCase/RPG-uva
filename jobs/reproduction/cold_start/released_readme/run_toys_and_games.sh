...
#SBATCH --job-name=rpg_cold_toys_rel
...
export COLD_START_CONFIG="${COLD_START_CONFIG:-${REPO_ROOT}/configs/rpg/repro/toys_and_games.yaml}"
export COLD_START_OUTPUT_DIR="${COLD_START_OUTPUT_DIR:-${REPO_ROOT}/artifacts/rpg/cold_start/released_readme/toys_and_games}"
