...
#SBATCH --job-name=rpg_eval_cds_appx
...
export EVAL_CONFIG="${EVAL_CONFIG:-${REPO_ROOT}/configs/rpg/eval_seeds/paper_appendix/cds_and_vinyl.yaml}"
export EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-${REPO_ROOT}/artifacts/rpg/eval_seeds/paper_appendix/cds_and_vinyl}"
export PAPER_METRIC="${PAPER_METRIC:-ndcg@10}"
export PAPER_VALUE="${PAPER_VALUE:-0.0415}"
