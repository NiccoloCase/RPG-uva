...
#SBATCH --job-name=rpg_eval_sports_appx
...
export EVAL_CONFIG="${EVAL_CONFIG:-${REPO_ROOT}/configs/rpg/eval_seeds/paper_appendix/sports_and_outdoors.yaml}"
export EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-${REPO_ROOT}/artifacts/rpg/eval_seeds/paper_appendix/sports_and_outdoors}"
