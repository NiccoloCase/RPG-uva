...
#SBATCH --job-name=rpg_sports_and_outdoors
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "rpg_sports_and_outdoors"
...
runtime_stats_run python3 scripts/rpg.py --preset sports_and_outdoors
