...
#SBATCH --job-name=sasrec_cds_size_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_cds_size_train"
...
runtime_stats_run python3 scripts/sasrec.py \
  ...
  --run_id sasrec_cds_and_vinyl_size_match \
  --hidden_size 328
