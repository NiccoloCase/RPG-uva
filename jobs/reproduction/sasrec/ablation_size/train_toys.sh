...
#SBATCH --job-name=sasrec_toys_size_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_toys_size_train"
...
runtime_stats_run python3 scripts/sasrec.py \
  ...
  --run_id sasrec_toys_and_games_size_match \
  --hidden_size 396
