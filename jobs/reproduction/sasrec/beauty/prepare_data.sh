...
#SBATCH --job-name=sasrec_beauty_prep
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_beauty_prepare"
...
runtime_stats_run conda run -n rpg-uva python3 scripts/sasrec_prepare_data.py --categories Beauty
