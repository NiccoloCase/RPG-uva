...
#SBATCH --job-name=sasrec_beauty_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_beauty_train"
...
runtime_stats_run python3 scripts/sasrec.py --preset beauty --dataset Beauty
