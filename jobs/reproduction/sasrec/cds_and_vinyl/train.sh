...
#SBATCH --job-name=sasrec_cds_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_cds_and_vinyl_train"
...
runtime_stats_run python3 scripts/sasrec.py --preset cds_and_vinyl --dataset CDs_and_Vinyl
