...
#SBATCH --job-name=sasrec_cold_beauty_rel
...
export COLD_START_PRESET="${COLD_START_PRESET:-beauty}"
export COLD_START_DATASET="${COLD_START_DATASET:-Beauty}"
export COLD_START_OUTPUT_DIR="${COLD_START_OUTPUT_DIR:-${REPO_ROOT}/artifacts/sasrec/cold_start/released_readme/beauty}"
