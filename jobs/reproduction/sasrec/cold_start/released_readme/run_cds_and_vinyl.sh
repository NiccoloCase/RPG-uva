...
#SBATCH --job-name=sasrec_cold_cds_rel
...
export COLD_START_DATASET_SLUG="${COLD_START_DATASET_SLUG:-cds_and_vinyl}"
export COLD_START_PRESET="${COLD_START_PRESET:-cds_and_vinyl}"
export COLD_START_DATASET="${COLD_START_DATASET:-CDs_and_Vinyl}"
export COLD_START_OUTPUT_DIR="${COLD_START_OUTPUT_DIR:-${REPO_ROOT}/artifacts/sasrec/cold_start/released_readme/cds_and_vinyl}"
