...
# Submit from jobs/reproduction/sasrec/eval_seeds so these relative output paths resolve correctly.
...
#SBATCH --output=../../../../output/reproduction/sasrec/eval_seeds/%x-%j.out
#SBATCH --error=../../../../output/reproduction/sasrec/eval_seeds/%x-%j.err
...
OUTPUT_DIR="${REPO_ROOT}/output/reproduction/sasrec/eval_seeds"
...
SASREC_EVAL_DATASET_SLUG="${SASREC_EVAL_DATASET_SLUG:-sports_and_outdoors}"
SASREC_EVAL_PRESET="${SASREC_EVAL_PRESET:-${SASREC_EVAL_DATASET_SLUG}}"
SASREC_EVAL_DATASET="${SASREC_EVAL_DATASET:-Sports_and_Outdoors}"
...
runtime_stats_run conda run -p "${ENV_PREFIX}" python scripts/sasrec_eval.py \
