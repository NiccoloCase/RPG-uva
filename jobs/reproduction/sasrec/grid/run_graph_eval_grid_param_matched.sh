...
# SASRec parameter-matched graph-decoding hyperparameter grid on the original Sports pool.
# Submit from this directory:
#   cd jobs/reproduction/sasrec/grid
#   mkdir -p ../../../../output/reproduction/sasrec/grid/graph_eval_param_matched
...
#SBATCH --output=../../../../output/reproduction/sasrec/grid/graph_eval_param_matched/%x-%j.out
#SBATCH --error=../../../../output/reproduction/sasrec/grid/graph_eval_param_matched/%x-%j.err
...
OUTPUT_DIR="${REPO_ROOT}/output/reproduction/sasrec/grid/graph_eval_param_matched"
...
GRID_OUTPUT_DIR="${REPO_ROOT}/artifacts/sasrec/grid/graph_eval/param_matched/sports_and_outdoors"
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_graph_grid_param_matched_sports_and_outdoors"
