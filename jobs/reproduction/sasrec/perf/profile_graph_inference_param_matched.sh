...
# SASRec parameter-matched graph-profile run on Sports using the best graph grid setting.
# Submit from this directory:
#   cd jobs/reproduction/sasrec/perf
#   mkdir -p ../../../../output/reproduction/sasrec/perf/graph_profile_param_matched
...
#SBATCH --output=../../../../output/reproduction/sasrec/perf/graph_profile_param_matched/%x-%j.out
#SBATCH --error=../../../../output/reproduction/sasrec/perf/graph_profile_param_matched/%x-%j.err
...
OUTPUT_DIR="${REPO_ROOT}/output/reproduction/sasrec/perf/graph_profile_param_matched"
...
PERF_OUTPUT_DIR="${REPO_ROOT}/artifacts/sasrec/perf/graph/param_matched/sports_and_outdoors"
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_graph_profile_param_matched_sports_and_outdoors"
