...
#SBATCH --job-name=sasrec_sports_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_sports_and_outdoors_train"
...
runtime_stats_run python3 scripts/sasrec.py --preset sports_and_outdoors --dataset Sports_and_Outdoors
