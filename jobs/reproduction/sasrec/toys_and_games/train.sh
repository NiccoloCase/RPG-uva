...
#SBATCH --job-name=sasrec_toys_and_games
#SBATCH --ntasks=1
...
init_sasrec_job "${OUTPUT_DIR}" "sasrec_toys_and_games"
load_sasrec_env

cd "${REPO_ROOT}"

echo "Training SASRec Toys_and_Games reproduction run"
echo "Config: configs/sasrec/root.yaml + configs/sasrec/repro/toys_and_games.yaml"
