...
#SBATCH --job-name=sasrec_toys_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_toys_and_games_train"
...
runtime_stats_run python3 scripts/sasrec.py --preset toys_and_games --dataset Toys_and_Games
