...
#SBATCH --job-name=sasrec_modernized_beauty_size_train
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_modernized_beauty_size_train"
...
runtime_stats_run python3 scripts/sasrec_modernized.py \
  ...
  --run_id sasrec_modernized_beauty_size_match \
  --hidden_size 540
