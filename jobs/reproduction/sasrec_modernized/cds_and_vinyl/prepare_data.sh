...
#SBATCH --job-name=sasrec_modernized_cds_prep
#SBATCH --ntasks=1
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_modernized_cds_and_vinyl_prepare"
...
runtime_stats_run python3 scripts/sasrec_prepare_data.py --categories CDs_and_Vinyl
