...
# SASRecModernized base graph-decoding hyperparameter grid on the original Sports pool.
# Submit from this directory:
#   cd jobs/reproduction/sasrec_modernized/grid
#   mkdir -p ../../../../output/reproduction/sasrec_modernized/grid/graph_eval_base
...
#SBATCH --output=../../../../output/reproduction/sasrec_modernized/grid/graph_eval_base/%x-%j.out
#SBATCH --error=../../../../output/reproduction/sasrec_modernized/grid/graph_eval_base/%x-%j.err
...
OUTPUT_DIR="${REPO_ROOT}/output/reproduction/sasrec_modernized/grid/graph_eval_base"
ENV_PREFIX="${REPO_ROOT}/artifacts/conda/rpg-uva"
GRID_CONFIG="${REPO_ROOT}/configs/sasrec/perf/sports_graph.yaml"
GRID_OUTPUT_DIR="${REPO_ROOT}/artifacts/sasrec_modernized/grid/graph_eval/base/sports_and_outdoors"
...
runtime_stats_init "${OUTPUT_DIR}" "sasrec_modernized_graph_grid_base_${PERF_DATASET_SLUG}"
