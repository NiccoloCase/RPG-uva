...
class SASRecModernizedSelfAttention(nn.Module):
...
class SASRecModernizedIntermediate(nn.Module):
    def __init__(self, args):
        super().__init__()
...
class SASRecModernizedLayer(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.attention = SASRecModernizedSelfAttention(args)
        self.intermediate = SASRecModernizedIntermediate(args)
...
class SASRecModernizedEncoder(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.layer = nn.ModuleList(
            SASRecModernizedLayer(args) for _ in range(args.num_hidden_layers)
        )
